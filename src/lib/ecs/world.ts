...
export class World {
	...
	public addComponent(entityId: EntityId, component: TagComponent): this;
	public addComponent<T extends ComponentData>(
		entityId: EntityId,
		component: Component<T>,
		data?: PartialComponentToKeys<T>,
		...
		{
			const componentId: number = (component as Internal<Component<T>>).componentId;
			if (
	...
	public addTag(entityId: EntityId, tag: TagComponent): this {
		return this.addComponent(entityId, tag);
	}
	 ...
	 */
	public hasComponent(entityId: EntityId, component: AllComponentTypes): boolean {
		const componentId: number = (component as Internal<AllComponentTypes>).componentId;
	...
	public hasTag(entityId: EntityId, tag: TagComponent): boolean {
		return this.hasComponent(entityId, tag);
	}
